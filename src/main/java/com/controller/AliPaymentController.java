...
public class AliPaymentController {
    ...
    public ModelAndView prepay(HttpServletRequest request, HttpServletResponse response, @PathVariable String orderNo){
        System.out.println("支付前订单信息确认.....");
        Map<String,Object> param=new HashMap<>();
        HttpSession session=request.getSession();
        try {
            param.put("orderNo",orderNo);
            ItripHotelOrder order=itripHotelOrderService.getItripHotelOrderListByMap(param);
